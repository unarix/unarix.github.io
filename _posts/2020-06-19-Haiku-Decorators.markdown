...
For the controlLook the steps are the same of the Decorator, let's do a quick review with the controlLook: 
...
I love the gradients, but i need they look good, very sutil... suppose that i want to modify the menubar gradient, ok see in this line, apparently he is setting the amount of "tint" for the initial color and its final color; Let's modify it:
